...
namespace uri {
  ...
  // Returns a valid URI for some portion of a path
  // Scheme is not returned by this method

  inline std::string partial_path(const std::string& filepath)
  {
#if __WINDOWS__
  ...
  {
      return "file://" + partial_path(filepath);
  }
}
