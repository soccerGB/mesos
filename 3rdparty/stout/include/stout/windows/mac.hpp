...
// specified using its name. It's name, on Windows, is also the MAC
// address, since that's the only unique identifier easily available
// from the Windows command line.
//
// Note that the name has the MAC address separated by dashes (as printed
